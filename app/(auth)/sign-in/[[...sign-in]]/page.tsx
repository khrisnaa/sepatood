        ...
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              ...
              >
                <Card className="w-full max-w-md space-y-4 py-4">
                  <CardHeader>
                    <CardTitle>Sign in to Sepatood</CardTitle>
                    <CardDescription>
                    ...
                    <div className="grid w-full gap-y-4">
                      <SignIn.Action submit asChild>
                        <Button disabled={isGlobalLoading}>
                          <Clerk.Loading>
                            {(isLoading) => {
                              return isLoading ? <ClipLoader /> : 'Continue';
                            }}
                          </Clerk.Loading>
                        </Button>
                      </SignIn.Action>
                    ...
                    <div className="grid w-full gap-y-4">
                      <SignIn.Action navigate="previous" asChild>
                        <Button disabled={isGlobalLoading}>
                          <Clerk.Loading>
                            {(isLoading) => {
                              return isLoading ? <ClipLoader /> : 'Go back';
                            }}
                          </Clerk.Loading>
                        </Button>
                      </SignIn.Action>
